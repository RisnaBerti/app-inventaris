    ...
    <div class="row h-100">
        <div class="col-lg-6 col-12">
            <div id="auth-left">
                <div class="logo">
                    <a href="/">
                        {{-- <img src="{{ asset('logo.jpg') }}" alt="Logo" style="width: 200px; height: auto;"> --}}
                        {{-- <img src="{{ asset('mazer') }}/static/images/logo/logo.svg" alt="Logo"> --}}
                    </a>
                </div>
                <div class="auth-logo">
                    <a href="/">
                        {{-- <img src="{{ asset('logo.jpg') }}" alt="Logo" style="width: 160px; height: auto;"> --}}
                        {{-- <img src="{{ asset('mazer') }}/static/images/logo/logo.svg" alt="Logo"> --}}
                    </a>
                </div>
                <h1>{{ __('Log in.') }}</h1>
                <p class="mb-3">{{ __('Selamat datang di Sistem Inventaris MA DARUL QUR\'AN WONOSARI!') }}</p>
            ...
            {{-- <div id="auth-right"> --}}
                {{-- <div class="carousel slide" data-bs-ride="carousel" id="carouselExampleIndicators">
                    <ol class="carousel-indicators">
                        <li class="active" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0"></li>
                        <li data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1"></li>
                        <li data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2"></li>
                    </ol>
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="{{ asset('logo.jpg') }}" class="d-block w-100"
                                alt="...">
                        </div>
